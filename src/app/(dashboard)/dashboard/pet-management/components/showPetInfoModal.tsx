...
export default function ShowPetInfoModal(props: any) {
              ...
              >
                ...
                <div id="content-2a" className="flex-1 overflow-auto">
                  {petData?.photos?.length && (
                    <ImageCarousel images={petData?.photos} />
                  )}
                </div>
                ...
                <div>
                  ...
                  <p className=" text-slate-400">Breed: {petData?.breed}</p>
                  <p className=" text-slate-400">Age: {petData?.age}</p>
                  ...
                  <p className=" text-slate-400">
                    Health status: {petData?.health_status}
                  </p>
                </div>
                {/*        <!-- Modal actions --> */}
